...
urlpatterns = [
    ...
    path('products/read/category/<int:pk>/', adminapp.CategoryProductsReadView.as_view(), name='products'),
    path('products/read/<int:pk>/', adminapp.CategoryProductsReadView.as_view(), name='product_read'),
